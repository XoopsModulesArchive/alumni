...
define($modinfo_lang."_ADMENU1", "Administration");
define($modinfo_lang."_ADMENU2", "Category Maintenance");
...
define($modinfo_lang."_NBDISPLSUBCAT","Number of subcategories to show :");
